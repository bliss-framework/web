...
It makes the team faster in understanding what is what, and after a while it comes to you naturally, it leads your way through code.
...
!!! note "Real life example"
    ...
    At [Baťa shoe maker company](https://en.wikipedia.org/wiki/Bata_Corporation), the marvel of efficiency and optimization, back in the 1930s, every worker on the assembly line had a toolbox that was hanging on the wall. This toolbox contained all tools that the worker station required, and it was facing the aisle between the stations. 
